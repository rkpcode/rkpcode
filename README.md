...
- 🌱 Learning Path: Python → Math (Statistics, Probability, Linear Algebra & Calculus)→ ML/DL → NLP → GenAI → Computer Vision  
...
---
## 📂Real World Project 
### 🔹 [Jewellery Shop Demand Forecasting System ](https://github.com/rkpcode/jewellery_demand_forecasting)
## 📊 GitHub Stats
